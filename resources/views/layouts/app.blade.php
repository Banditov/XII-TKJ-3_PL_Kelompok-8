...
<body class="overflow-hidden h-screen **:select-none">
    ...
    @persist('background')
        <div class="fixed inset-0 z-0 bg-slate-950">
            ...
            <div class="absolute inset-0 bg-linear-to-br from-blue-500/5 via-purple-500/5 to-pink-500/5 pointer-events-none"></div>
            ...
            <div class="absolute top-20 left-10 w-96 h-96 bg-blue-500/10 rounded-full blur-3xl animate-pulse pointer-events-none"></div>
            <div class="absolute bottom-40 right-10 w-80 h-80 bg-purple-500/10 rounded-full blur-3xl animate-pulse delay-1000 pointer-events-none"></div>
        </div>
    @endpersist
    ...
    <main class="flex h-full flex-col sm:flex-row">
        ...
        <div class="flex items-center justify-center p-10 pb-0 sm:hidden">
            <img src="{{ asset('images/logo-logimm.png') }}" class="w-60 drop-shadow-2xl">
        </div>
