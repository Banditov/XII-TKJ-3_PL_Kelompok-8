<section class="flex flex-col h-full">
    ...
    <header class="mb-8 flex items-center justify-between">
        <div class="flex flex-col gap-2 text-white">
            <h1 class="text-5xl font-bold">Edit Agenda</h1>
            <p class="font-semibold text-white/60">Perbarui informasi agenda yang ingin diubah.</p>
        </div>
    </header>
    ...
    <form wire:submit="update" class="flex flex-col h-full gap-8 justify-between">
        <!-- Title -->
