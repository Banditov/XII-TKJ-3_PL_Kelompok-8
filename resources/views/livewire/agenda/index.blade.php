            ...
            <div x-show="open" x-collapse
                ...
                @else
                    @foreach ($tasksNow as $task)
                        <div
                            class="w-full rounded-2xl border border-white/10 bg-white/5 p-4 text-white transition-all duration-300 hover:bg-white/10">
                            <p>{{ $task['title'] }}</p>
                        </div>
                    @endforeach
                @endif
                ...
                @foreach ($lateTasks as $lateTask)
                    <div
                        ...
                        <div class="flex flex-col gap-2 w-full">
                            <div
                                class="flex gap-2 sm:items-center justify-center sm:justify-start items-start sm:flex-row flex-col sm:gap-8">
