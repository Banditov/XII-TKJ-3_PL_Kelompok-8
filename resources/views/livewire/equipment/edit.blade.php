<section class="flex flex-col h-full">
    ...
    <header class="mb-8 flex items-center justify-between">
        <div class="flex flex-col gap-2 text-white">
            <h1 class="text-5xl font-bold">Perbarui Perlengkapan</h1>
    ...
    <form wire:submit="save" class="flex flex-col h-full gap-8 justify-between">
        ...
        <div class="flex flex-col gap-5">
            ...
            <div
                class="flex items-center gap-4 w-full p-2 bg-white/5 backdrop-blur-sm border border-white/15 rounded-xl">
                <button type="button"
                ...
                <input type="number" id="quantity" wire:model="quantity" min="1" value="1" placeholder="..."
        ...
        <div class="flex flex-col gap-5 h-full">
            ...
            <label for="notes" class="text-lg font-semibold text-white/80">
                Catatan Tambahan
            </label>
